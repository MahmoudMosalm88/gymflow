...
export const WHATSAPP_AUTOMATIONS: WhatsAppAutomationDefinition[] = [
  ...
  },
  {
    ...
    description: {
      en: "Day 0, 3, 7, and 14 recovery sequence. Visible now, locked until release.",
      ar: "تسلسل استرجاع في يوم 0 و3 و7 و14. ظاهر الآن لكنه مقفل حتى الإطلاق.",
    },
    status: "blocked",
    ownerControlled: true,
    editableTemplates: false,
  ...
  },
  {
    ...
    description: {
      en: "Welcome is live; later onboarding steps stay visible but locked.",
      ar: "رسالة الترحيب مفعلة؛ بقية خطوات التهيئة ظاهرة لكنها مقفلة.",
    },
    status: "blocked",
    ownerControlled: true,
    editableTemplates: false,
  ...
  },
  {
    ...
    description: {
      en: "Future behavior-based retention nudge. In scope, not implemented yet.",
      ar: "تنبيه احتفاظ سلوكي مستقبلي. ضمن النطاق لكنه غير منفذ بعد.",
    },
    status: "blocked",
    ownerControlled: true,
    editableTemplates: false,
  ...
  },
  {
    ...
    description: {
      en: "Future milestone encouragement. Supportive tone only.",
      ar: "رسائل تشجيع مستقبلية للإنجازات. بنبرة داعمة فقط.",
    },
    status: "blocked",
    ownerControlled: true,
    editableTemplates: false,
  ...
  },
  {
    ...
    description: {
      en: "Future reminder to bring frozen members back smoothly.",
      ar: "تذكير مستقبلي لإعادة الأعضاء المجمدين بسلاسة.",
    },
    status: "blocked",
    ownerControlled: true,
    editableTemplates: false,
  ...
  },
  {
    ...
    description: {
      en: "Owner-facing summary. Blocked today; always on when released and connected.",
      ar: "ملخص موجّه للمالك. محجوب حالياً ويصبح دائماً مفعلاً بعد الإطلاق والاتصال.",
    },
    status: "blocked",
    ownerControlled: false,
    editableTemplates: false,
