...
export const WHATSAPP_AUTOMATIONS: WhatsAppAutomationDefinition[] = [
  ...
  },
  {
    ...
    description: {
      en: "Day 0, 3, 7, and 14 recovery sequence. Available to owners and kept off until a branch enables it.",
      ar: "تسلسل استرجاع في يوم 0 و3 و7 و14. متاح للمالك ويظل متوقفاً حتى يفعله الفرع.",
    },
    triggerSummary: {
  ...
  },
  {
    ...
    description: {
      en: "Welcome stays live and the later onboarding steps are available to owners per branch.",
      ar: "رسالة الترحيب تبقى مفعلة، وبقية خطوات التهيئة متاحة للمالك على مستوى الفرع.",
    },
    triggerSummary: {
  ...
  },
  {
    ...
    description: {
      en: "Behavior-based retention nudge that owners can enable when they want attendance recovery support.",
      ar: "تنبيه احتفاظ سلوكي يمكن للمالك تفعيله عند الحاجة إلى استعادة الحضور.",
    },
    triggerSummary: {
  ...
  },
  {
    ...
    description: {
      en: "Milestone encouragement messages that owners can enable for attendance consistency wins.",
      ar: "رسائل تشجيع على الإنجاز يمكن للمالك تفعيلها لتعزيز انتظام الحضور.",
    },
    triggerSummary: {
  ...
  },
  {
    ...
    description: {
      en: "Freeze return reminder that owners can enable before members are due back.",
      ar: "تذكير بعودة العضو بعد التجميد يمكن للمالك تفعيله قبل موعد الرجوع.",
    },
    triggerSummary: {
