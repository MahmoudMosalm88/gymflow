...
export const landingCopy = {
  en: {
    ...
    faqItems: [
      ...
      { q: "How does pricing work?", a: "Single-branch gyms can start with a free trial. Larger, multi-branch, or migration-heavy rollouts can book a demo and get assisted setup before pricing is finalized." },
    ] as const,
  ...
  ar: {
    ...
    heroCtaSecondary: "احجز عرضًا توضيحيًا",
    ...
    faqItems: [
      ...
      { q: "كيف تعمل الأسعار؟", a: "يمكن للجيمات ذات الفرع الواحد أن تبدأ بتجربة مجانية. أما الجيمات الأكبر أو متعددة الفروع أو التي تحتاج ترحيلاً معقداً، فيمكنها حجز عرض والحصول على إعداد مُوجَّه قبل تثبيت السعر النهائي." },
    ] as const,
